    ...
    >
      ...
      <div className="relative h-full p-5 flex flex-col justify-between">
        ...
        <div className="flex items-start justify-between">
          <p className="text-[11px] uppercase tracking-widest text-white/80 font-medium">
            {name}
          </p>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            {/* simulated chip */}
            <div
              className="h-7 w-9 rounded-md border border-yellow-200/40"
              style={{
                background:
            ...
            {/* contactless icon */}
            <svg viewBox="0 0 24 24" className="h-5 w-5 text-white/80" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
              <path d="M5 7.5a10 10 0 0 1 0 9" />
              <path d="M9 9.5a6 6 0 0 1 0 5" />
              <path d="M13 11.5a2 2 0 0 1 0 1" />
            </svg>
          </div>
          <p className="font-mono text-lg sm:text-xl tracking-[0.25em] tabular">
            •••• •••• •••• {masked}
          </p>
        </div>
